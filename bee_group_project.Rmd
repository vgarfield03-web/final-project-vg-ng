...
>>>>>>> d25d2da9bd4bda9b8c57c2feb3ac088a389c23d1
```
...
<<<<<<< HEAD
```{r}
# Which species uses which landscape, this is a species x landcover x bee count table, 
...
<<<<<<< HEAD
```{r}
# plotting bee density/distribution 
...
<<<<<<< HEAD
  filter(county %in% c("Wheeler", "Multnomah")) %>%
  st_set_geometry(NULL) %>%
